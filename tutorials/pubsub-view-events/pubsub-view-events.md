...
Just as a quick test, let's use the Try Me! functionality to quickly establish a connection and exchange a message. You will achieve the communication scenario below.
